...
**Halal Paisa**  
FinTech platform for secure financial transactions and digital payment workflows.  
...
**Golden Tree Network**  
Business/network platform for managing users, workflows, and enterprise operations.  
...
- ERP & CRM Development
- LMS Platforms (Laravel + Vue + Inertia)
- RESTful API Design
...
🌐 Portfolio: https://servex.apextelephony.org/
